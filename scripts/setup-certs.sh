...
echo "=== Koastcast Tailscale certificate setup ==="
echo ""
...
echo ""
echo "Koastcast is accessible at: https://$TS_HOSTNAME:8443"
echo ""
...
echo "  0 3 * * 1 $SCRIPT_DIR/renew-certs.sh >> /var/log/koastcast-certs.log 2>&1"
