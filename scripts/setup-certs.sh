...
echo "=== nSwell Tailscale certificate setup ==="
echo ""
...
echo ""
echo "nSwell is accessible at: https://$TS_HOSTNAME:8443"
echo ""
...
echo "  0 3 * * 1 $SCRIPT_DIR/renew-certs.sh >> /var/log/nswell-certs.log 2>&1"
