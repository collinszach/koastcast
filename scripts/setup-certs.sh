...
echo "=== Peakcast Tailscale certificate setup ==="
echo ""
...
echo ""
echo "Peakcast is accessible at: https://$TS_HOSTNAME:8443"
echo ""
...
echo "  0 3 * * 1 $SCRIPT_DIR/renew-certs.sh >> /var/log/peakcast-certs.log 2>&1"
